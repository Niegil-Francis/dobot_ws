// This code can be used to enter different positions for pick and place 
// The dobot then moves through these positions and performs the operation
...
int main(int argc, char **argv)
{
	...
	{
    // In order to record a set of poses uncomment the following line
    // std::cout<<pose[j][0]<<","<<pose[j][1]<<","<<pose[j][2]<<";"<<"\n";
	
    // To check the poses added along with the position uncomment the following
    ROS_INFO("\n Position %d\n",counter);
    ROS_INFO("x: %d",pose[counter][0]);
